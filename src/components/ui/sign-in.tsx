        ...
        <div className="w-full max-w-md">
          <div className="flex flex-col gap-6">
            ...
            <form ref={formRef} className="space-y-5" onSubmit={onSignIn}>
              ...
              {showRememberMe && showPasswordField && (
            ...
            {onGoogleSignIn && (
              <>
                ...
                <button
                  ...
                  className="animate-element animate-delay-900 w-full flex items-center justify-center gap-3 border border-border rounded-2xl py-4 hover:bg-secondary transition-colors text-foreground"
                >
                  <GoogleIcon />
